...
".\asar\asar.exe" --no-title-check --symbols=wla --symbols-path=".\build\X-Fusion Practice Hack.sym" -DSAVESTATES=0 ".\main.asm" ".\build\00.sfc"
...
echo.
python ".\create_dummies.py" ".\build\00.sfc" ".\build\ff.sfc"
".\asar\asar.exe" --no-title-check --symbols=wla --symbols-path=".\build\X-Fusion Practice Hack (Savestates).sym" ".\main.asm" ".\build\00.sfc"
