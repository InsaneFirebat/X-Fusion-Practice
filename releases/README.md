...
The patch file with "Savestates" in the filename is only intended for SD2SNES, FXPAK, Super NTs (with "jailbreak" firmware), and later versions of Snes9x. It may cause crashes or serious graphical errors if used with some emulators or Everdrives.
